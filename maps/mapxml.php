...
<?php
	...
	$query = "SELECT Latitude, Longitude, NodeType FROM Location WHERE AccidentNo IN (SELECT AccidentNo FROM Accident WHERE EXTRACT( QUARTER FROM AccidentDate ) =4 and EXTRACT(YEAR FROM AccidentDate) =2014)";
