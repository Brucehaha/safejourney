...
<?php
	...
	$query = "SELECT count(*) AS 'Count', Latitude, Longitude, NodeType FROM Location WHERE AccidentNo in (SELECT AccidentNo from Accident where EXTRACT(YEAR FROM AccidentDate) = 2014) group by Latitude, Longitude, NodeType limit 4000, 2000";
